...
#Region "DataAccess"
    ...
    Public Sub Update()
        ...
        Try
            ...
            'Requête
            Dim query As String = "UPDATE Session SET Login = @Login, Password=@Password, IsAddCmd = @IsAddCmd, IsUpdCmd = @IsUpdCmd, IsDelCmd = @IsDelCmd, IsDispCA = @IsDispCA, IsDispPanel = @IsDispPanel, IsUpdConfig = @IsUpdConfig, " +
